...
$extension_options_name = WPSOLR_Option::OPTION_EXTENSION_GOOGLE_DOC_EMBEDDER;
$settings_fields_name   = 'extension_google_doc_embedder_opt';

$extension_options = WPSOLR_Service_Container::getOption()->get_option_google_doc_embedder();
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_GOOGLE_DOC_EMBEDDER ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GOOGLE_DOC_EMBEDDER, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GOOGLE_DOC_EMBEDDER, 'Save Options', true, true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
