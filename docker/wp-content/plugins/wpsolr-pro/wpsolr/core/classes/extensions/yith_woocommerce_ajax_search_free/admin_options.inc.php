                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_YITH_WOOCOMMERCE_AJAX_SEARCH_FREE ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_YITH_WOOCOMMERCE_AJAX_SEARCH_FREE, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_YITH_WOOCOMMERCE_AJAX_SEARCH_FREE, 'Save Options', true, true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
