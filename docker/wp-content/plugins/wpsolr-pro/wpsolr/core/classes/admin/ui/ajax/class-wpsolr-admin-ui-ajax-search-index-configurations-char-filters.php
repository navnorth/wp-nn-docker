 ...
 * Retrieve Filters
 *
 * Class WPSOLR_Admin_UI_Ajax_Search_Index_Configurations_Char_Filters
 * @package wpsolr\core\classes\admin\ui\ajax
 */
class WPSOLR_Admin_UI_Ajax_Search_Index_Configurations_Char_Filters extends WPSOLR_Admin_UI_Ajax_Search {
	...
	public static function execute_parameters( $parameters ) {
		...
		foreach ( WPSOLR_Configuration_Builder_Factory::get_char_filters() as $builder_class_name ) {
