...
switch ( $subtab ) {
	...
	case 'extension_theme_jobify_opt':
		WpSolrExtensions::require_once_wpsolr_extension_admin_options( WpSolrExtensions::EXTENSION_THEME_JOBIFY );
		break;

	case 'extension_theme_listable_opt':
		WpSolrExtensions::require_once_wpsolr_extension_admin_options( WpSolrExtensions::EXTENSION_THEME_LISTABLE );
		break;

	case 'extension_theme_directory2_opt':
		WpSolrExtensions::require_once_wpsolr_extension_admin_options( WpSolrExtensions::EXTENSION_THEME_DIRECTORY2 );
		break;
