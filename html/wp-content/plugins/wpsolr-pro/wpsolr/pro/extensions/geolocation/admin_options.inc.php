...
$extension_options_name = WPSOLR_Option::OPTION_EXTENSION_GEOLOCATION;
$settings_fields_name   = 'extension_geolocation_opt';

$options = WPSOLR_Service_Container::getOption()->get_option_geolocation();
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <select
						...
						<?php
						$current_value = WPSOLR_Service_Container::getOption()->get_option_geolocation_default_sort();
						foreach ( WPSOLR_Option_GeoLocation::get_sort_fields() as $sort ) {
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    ...
                    <p>
                        This option can only be used with the deprecated WPSOLR Ajax theme.
                        Rather use the code on <a
                                href="https://www.wpsolr.com/guide/configuration-step-by-step-schematic/activate-extensions/extension-geolocation/"
                                target="_new">your own theme search template</a>.
                        <br>Leave empty if you do not
                        wish to show distance.
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    ...
                    <p>
                        ...
                        Also, the submitted form is added the css class "wpsolr_geo_loading" while the browser is
                        retrieving the visitor location. You can use this class to show some loading icon for instance.
                    </p>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    ...
                    <p>
                        If some of your post types does not contain geolocation coordinates, this option will filter
                        them out from the results. It prevents showing messy wrong distances of 1000s of kilometers.
                    </p>
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_GEOLOCATION ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GEOLOCATION, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_GEOLOCATION, 'Save Options', true, true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
