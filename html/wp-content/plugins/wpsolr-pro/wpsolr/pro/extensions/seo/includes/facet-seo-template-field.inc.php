...
<div style="display:none"
    ...
    <input type='text'
           ...
           placeholder="<?php echo WPSOLR_Option::FACET_LABEL_SEO_TEMPLATE; ?>"
           name='wdm_solr_facet_data[<?php echo WPSOLR_Option::OPTION_FACET_FACETS_SEO_PERMALINK_TEMPLATE; ?>][<?php echo $selected_val; ?>]'
           value='<?php echo esc_attr( empty( $facet_seo_template ) ? WPSOLR_Option::FACET_LABEL_SEO_TEMPLATE : $facet_seo_template ); ?>'
    ...
    <p>
        ...
        variable <?php echo WPSOLR_Option::FACET_LABEL_TEMPLATE_VAR_VALUE; ?> to replace with the current facet item
        localized value.
    </p>
