...
WpSolrExtensions::require_once_wpsolr_extension( WpSolrExtensions::EXTENSION_THEME_JOBIFY, true );
...
$is_theme_active   = WpSolrExtensions::is_plugin_active( WpSolrExtensions::EXTENSION_THEME_JOBIFY );
    ...
    <form action="options.php" method="POST" id='extension_groups_settings_form'>
        ...
        <div class='wrapper'>
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox' <?php echo $is_theme_active ? '' : 'readonly' ?>
                           name='<?php echo $extension_options_name; ?>[<?php echo WPSOLR_Option::OPTION_THEME_JOBIFY_IS_REPLACE_LISTING_SEARCH; ?>]'
                           value='y'
            ...
            <div class="wdm_row">
                ...
                <div class='col_right'>
                    <input type='checkbox' <?php echo $is_theme_active ? '' : 'readonly' ?>
                           ...
                           name='<?php echo $extension_options_name; ?>[<?php echo WPSOLR_Option::OPTION_THEME_JOBIFY_IS_CACHING; ?>]'
                           value='y'
            ...
            <div class='wdm_row'>
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_JOBIFY ) ) { ?>
                        <div
                                class="wpsolr_premium_block_class"><?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_JOBIFY, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ); ?></div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_JOBIFY, 'Save Options', true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
