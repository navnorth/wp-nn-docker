...
$extension_options_name = WPSOLR_Option::OPTION_EXTENSION_TABLEPRESS;
$settings_fields_name   = 'extension_tablepress_opt';

$extension_options = WPSOLR_Service_Container::getOption()->get_option_tablepress();
                ...
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_TABLEPRESS ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_TABLEPRESS, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_TABLEPRESS, 'Save Options', true, true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
