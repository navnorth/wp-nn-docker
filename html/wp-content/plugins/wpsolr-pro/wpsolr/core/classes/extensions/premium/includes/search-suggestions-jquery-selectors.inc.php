...
<div class="wdm_row">
    <div
            class='col_left'><?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'Attach the suggestions list to your own search boxes', true, true ); ?>
