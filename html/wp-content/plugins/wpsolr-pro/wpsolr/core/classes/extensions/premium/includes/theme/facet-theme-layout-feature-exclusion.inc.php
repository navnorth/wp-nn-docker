...
<div style="display:none"
    ...
    <div class="wdm_row" style="top-margin:5px;">
        <div class='col_left'>
			<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'Do not use other items selections to calculate the items count', true ); ?>
        </div>
        <div class='col_right'>
            <input type='checkbox'
