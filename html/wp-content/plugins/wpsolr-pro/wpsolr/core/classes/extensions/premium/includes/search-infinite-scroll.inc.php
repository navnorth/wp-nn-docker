...
<div class="wdm_row">
    <div class='col_left'>
		<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'Activate the Infinite scroll pagination', true ); ?>
...
<div class="wdm_row">
    <div class='col_left'>
		<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'Replace the Infinite scroll javascript with my own', true ); ?>
		<?php echo WPSOLR_Help::get_help( WPSOLR_Help::HELP_SEARCH_INFINITE_SCROLL ); ?>
    </div>
    <div class='col_right'>
        <input type='checkbox'
