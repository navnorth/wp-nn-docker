 ...
 * Retrieve Tokenizers
 *
 * Class WPSOLR_Admin_UI_Ajax_Search_Index_Configurations_Tokenizers
 * @package wpsolr\core\classes\admin\ui\ajax
 */
class WPSOLR_Admin_UI_Ajax_Search_Index_Configurations_Tokenizers extends WPSOLR_Admin_UI_Ajax_Search {
	...
	public static function execute_parameters( $parameters ) {
		...
		foreach ( WPSOLR_Configuration_Builder_Factory::get_tokenizers() as $builder_class_name ) {
