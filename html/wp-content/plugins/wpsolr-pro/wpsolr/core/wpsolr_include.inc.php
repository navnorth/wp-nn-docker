...
// Definitions
define( 'WPSOLR_PLUGIN_VERSION', '20.9' );
...
function add_remove_document_to_solr_index( $post_id, $post ) {
	...
	if ( ! WPSOLR_Model_Type_Abstract::get_is_model_type_can_be_indexed( $post->post_type ) ) {
		return;
	}
			...
			[
				'data' =>
					[
						...
						'wpsolr_autocomplete_is_active'      => ! WPSOLR_Service_Container::getOption()->get_search_is_galaxy_slave(),
