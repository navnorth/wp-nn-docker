                                            ...
                                            <div class="wdm_row" style="top-margin:5px;">
                                                ...
                                                <div class='col_right'>
                                                    <select
														...
														?>
                                                            name='<?php echo WPSOLR_Option::OPTION_SEARCH_FIELDS; ?>[<?php echo WPSOLR_Option::OPTION_SEARCH_FIELDS_BOOST_TYPE; ?>][<?php echo $selected_val; ?>]'
                                                    >
														<?php
            ...
            <div class='wdm_row'>
                <div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_PREMIUM ) ) { ?>
                        <div
                                class="wpsolr_premium_block_class"><?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?></div>
                        <input name="save_fields_options_form" id="save_fields_options_form"
                               type="submit" class="button-primary wdm-save"
                               value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'Save Options', true, true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
