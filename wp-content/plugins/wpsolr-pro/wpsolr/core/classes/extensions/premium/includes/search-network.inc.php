...
<div class="wdm_row">
    <div class='col_left'>
		<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_PREMIUM, 'This search is part of a network search', true, true ); ?>
    ...
    <div class='col_right'>
        <select
			...
			$options = [
				[
					'code'  => '',
					'label' => 'No (Do not change it unless you use WPSOLR with a network of sites)'
				],
				[
