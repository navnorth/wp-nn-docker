...
$extension_options_name = WPSOLR_Option::OPTION_EXTENSION_TYPES;
$settings_fields_name   = 'solr_extension_types_options';

$extension_options = WPSOLR_Service_Container::getOption()->get_option_toolset_types();
...
if ( $is_plugin_active ) {
	$ml_plugin = WPSOLR_Plugin_Types::create();
}
?>
                ...
                <div class="submit">
					<?php if ( ! $license_manager->is_installed || $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_TYPES ) ) { ?>
                        <div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_TYPES, OptionLicenses::TEXT_LICENSE_ACTIVATED, true ); ?>
                        </div>
                        <input
                                ...
                                value="Save Options"/>
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( true, OptionLicenses::LICENSE_PACKAGE_TYPES, 'Save Options', true ); ?>
                        <br/>
					<?php } ?>
                </div>
            </div>
